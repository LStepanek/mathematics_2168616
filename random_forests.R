...
#### přetypovávám textové proměnné na faktorové -------------------------------
...
for(
    ...
    if(
        class(my_data[, my_variable]) == "character"
    ){
...
if(
    file.exists("random_forests.txt")
){
    invisible(
        file.remove("random_forests.txt")
    )
}
...
#### přetypovávám faktorové proměnné na textové -------------------------------
...
for(
    ...
    if(
        class(my_data[, my_variable]) == "factor"
    ){
